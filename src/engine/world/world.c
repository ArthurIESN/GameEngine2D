...
World* World_init()
{
    ...
    world->WorldObjects = malloc(sizeof(WorldObjects));
    world->WorldObjects->staticObjects = malloc(sizeof(WorldStaticObject));
    world->WorldObjects->staticObjectsCount = 0;
    world->WorldObjects->dynamicObjects = malloc(sizeof(WorldDynamicObject));
